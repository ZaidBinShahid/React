        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              TextUtils reports the number of characters and words. Thus it is suitable for writing text with word/ character limit.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
             This word counter software works in any web browsers such as chrome, Firebox, Internet Explorer,
             Safari, Opera. It suits to count character in facebook, blog, books, excel, document, pgf document, 
             essays etc. 
            </div>
          </div>
        </div>
